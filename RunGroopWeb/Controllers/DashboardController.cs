...
namespace RunGroopWeb.Controllers
{
    public class DashboardController : Controller
    {
        ...
        private void MapUserEdit(AppUser user,EditUserDashboardModel editVM, ImageUploadResult photoResult)
        {
            user.Id = editVM.Id;
        ...
        public async Task<IActionResult> EditUserProfile()
        {
            ...
            var editUserViewModel = new EditUserDashboardModel()
            {
                Id = curUserId,
                Pace = user.Pace,
        ...
        [HttpPost]
        public async Task<IActionResult> EditUserProfile(EditUserDashboardModel editVM)
        {
            ...
            else
            {
                ...
                {
                    ModelState.AddModelError("", "Cant delete photo");
                    return View(editVM);
                }
                var photoResult = await _photoService.AddPhotoAsync(editVM.Image);
